...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    ...
	    <script src="${syspath}/deng/source/plugins/admin/index/global/plugins/bootstrap-treegrid/js/jquery.treegrid.extension.js"></script>
        <!-- treegrid插件结束 -->
        <!-- 日期选择器控件开始 -->
        ...
        <!-- 数字自增插件结束 -->
        <!-- 其他插件开始 -->
        <script src="${syspath}/deng/source/plugins/admin/index/global/plugins/layer/layer.js" type="text/javascript"></script>
		...
		<style type="text/css">
			...
			.input-group-btn .btn{padding: 9px;}
