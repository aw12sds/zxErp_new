...
//保存
function addZxReservedFunds(){
	submitBForm('defaultForm','../zxReservedFundsController/addZxReservedFunds','../zxReservedFundsController/loadZxReservedFunds');
}
//初始化日期选择器
...
function toChooseUser(){
	tlocation('../zxReservedFundsController/toZxReservedFundsUserChoose');
}
function toSum(){
