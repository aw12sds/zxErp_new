...
initBFileRight('problem_pic','problem_pic_pic',2);
/**初始化附件右键菜单结束**/
/**配置附件回显方法开始**/
...
/**初始化附件右键菜单开始 参数4为1表示拥有上传和删除功能 即新增和编辑页面使用**/
initBFileRight('result_pic','result_pic_pic',2);
/**初始化附件右键菜单结束**/
/**配置附件回显方法开始**/
var params = {xt_attachment_id:$('#result_pic').val(),field_name:'result_pic'};
ajaxBFilePathBackRequest('../xtCommonController/getAttachmentPathPP',params);
/**配置附件回显方法结束**/
