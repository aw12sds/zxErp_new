...
//保存
function addZxStaffRecord(){
	submitBForm('defaultForm','../zxStaffRecordController/addZxStaffRecord','../zxStaffRecordController/loadZxStaffRecord');
}
//员工选择器
function toChooseUser(){
	tlocation('../zxStaffRecordController/toZxStaffRecordUserChoose');
}
//初始化日期选择器
$(document).ready(function(){
	datetimeInit();
	InitBDataCombo("whether","residence_permit");
	InitBDataCombo("whether","social_security_cards");
	InitBDataCombo("xt_userinfo_highestDegree","userinfo_highestDegree");
});
/////////////////////部门选择器开始///////////////////
