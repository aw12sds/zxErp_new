...
function doGoodsSelect(){
	...
	if (nodes.length != 1) {
		...
		document.getElementById('classify_parentId_name').value=nodes[0].name;
		document.getElementById('classify_parentId').value=nodes[0].id;
