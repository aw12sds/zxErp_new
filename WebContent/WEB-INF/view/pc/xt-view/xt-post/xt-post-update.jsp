...
<body>
	<div class="panel panel-default padding-10 no-margin">
		<legend><button type="button" onclick="goback()" class="btn btn-default pull-right"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>返回</button>编辑岗位</legend>
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-3">
					<div class="input-group spinner" data-trigger="spinner">
					    <input type="text" class="form-control text-right" value="${xtPost.xt_post_maxNum }" data-bv-numeric data-bv-numeric-message="岗位最大人数为数字类型" name="xt_post_maxNum" placeholder="请输入岗位最大人数" data-min="0" data-step="1" data-rule="quantity">
				...
				<div class="col-lg-3">
					<div class="input-group spinner" data-trigger="spinner">
					    <input type="text" class="form-control text-right" value="${xtPost.xt_post_grade }" data-bv-numeric data-bv-numeric-message="岗位级别为数字类型" name="xt_post_grade" placeholder="请输入岗位级别" data-min="0" data-step="1" data-rule="quantity">
					    <span class="input-group-addon">
					        <a href="javascript:;" class="spin-up" data-spin="up"><i class="fa fa-caret-up"></i></a>
					        <a href="javascript:;" class="spin-down" data-spin="down"><i class="fa fa-caret-down"></i></a>
					    </span>
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn btn-success" onclick="updateXtPost()">
