...
<body>
	<div class="panel panel-default padding-10 no-margin">
		<legend><button type="button" onclick="goback()" class="btn btn-default pull-right"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>返回</button>编辑部门信息</legend>
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group has-feedback">
				...
				<div class="col-lg-3">
					<input class="form_date form-control" type="text" maxlength="20" readonly="readonly" name="xt_departinfo_time" placeholder="请输入立成时间" value="${xtDepartinfo.xt_departinfo_time }">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn btn-success" onclick="updateXtDepartinfo()">
