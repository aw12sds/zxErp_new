	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			<div class="form-group">
				<label class="col-lg-3 control-label">上级目录</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="100"  id="classify_parentId_name" name="classify_parentId_name" placeholder="请选择分类" onclick="GoodsSelect()">
				</div>
			</div>
			<div class="form-group" style="display:none">
				<label class="col-lg-3 control-label">上级目录id</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="100"   id="classify_parentId" name="classify_parentId" placeholder="请输入办公用品名称">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">目录名</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="100"  id=classify_name" name="classify_name" placeholder="请输入办公用品名称">
				</div>
			</div>
			<div class="form-group" style="display:none">
				<label class="col-lg-3 control-label">目录id</label>
				<div class="col-lg-6">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="100"  id="classify_sort" name="classify_sort" placeholder="请输入办公用品名称">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label"></label>
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="addZxOfficeClassfy()">保存</button>
...
<script type="text/javascript" src="../view/pc/zx-view/zx-office/zx-office-classify-add.js"></script> 
</html>
