...
<body>
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			<button class="btn btn-default" onclick="ZxReservedFundsUserChoose()">
...
<script type="text/javascript" src="../view/pc/zx-view/zx-reserved-funds/zx-reserved-funds-user-choose.js"></script> 
</html>
