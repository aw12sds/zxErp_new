...
<body>  
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			<button class="btn btn-default" onclick="toZxSixSContentAdd()">
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
			</button>
			<button class="btn btn-default" onclick="toZxSixSContentUpdate()">
			...
			<button class="btn btn-default" onclick="delZxSixSContent()">
			...
			<button class="btn btn-default" onclick="toZxSixSContentQueren()">
				<span class="glyphicon glyphicon-bookmark" aria-hidden="true"></span>确认
			</button>
		</div>
