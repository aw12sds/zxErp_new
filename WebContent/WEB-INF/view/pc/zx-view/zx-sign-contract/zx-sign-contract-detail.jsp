	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form_date form-control" name="create_time" readonly="readonly" placeholder="请选择时间" value="${zxSignContract.create_time }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">签署日期</label>
				<div class="col-lg-6">
					<input class="form_date form-control" name="sign_time" readonly="readonly" placeholder="请选择时间" value="${zxSignContract.sign_time }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">开始日期</label>
				<div class="col-lg-6">
					<input class="form_date form-control" name="begin_time" readonly="readonly" placeholder="请选择时间" value="${zxSignContract.begin_time }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">结束日期</label>
				<div class="col-lg-6">
					<input class="form_date form-control" name="end_time" readonly="readonly" placeholder="请选择时间" value="${zxSignContract.end_time }">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">备注</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="255" readonly="readonly" name="remark" placeholder="备注" value="${zxSignContract.remark}">
				</div>
			</div>
			<div class="form-group">
