...
<head>
<meta charset="UTF-8">
<title>车辆回司登记页面</title>
</head>
<body>
	<div class="panel panel-default padding-10 no-margin">
		<fieldset>
			<legend><button type="button" onclick="goback()" class="btn btn-default pull-right"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>返回</button>车辆回司登记</legend>
            <div class="container-fluid  col-md-8 col-md-offset-2">
                <div class="row">
                <form class="form-horizontal" id="defaultForm" method="post">
                	<input class="form-control" type="hidden" name="id" value="${zxCarApply.id }">
                	<input class="form-control" type="hidden" name="out_mileage" value="${zxCarApply.out_mileage }">
		                    ...
		                    <tr>
		                        ...
		                        <td>
		                        	<div class="input-group spinner" data-trigger="spinner">
									    <input type="text" class="form-control text-center" value="0" name="back_mileage" placeholder="请输入出车里程" data-min="0" data-step="1" data-rule="currency">
		                        ...
		                        <td>
		                        	<div class="form-group has-feedback no-margin">
			                            <div class="col-md-12">
			                                <input class="form_datetime form-control" name="usercar_backtime" data-bv-notempty data-bv-notempty-message="请选择出门时间"  placeholder="请选择时间">
...
<script type="text/javascript" src="../view/pc/zx-view/zx-car-apply/zx-car-apply-check-back.js"></script> 
</html>
