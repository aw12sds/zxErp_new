                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <c:choose>
                                    	<c:when test="${empty xtUserinfo.xt_userinfo_image}">
                                    		<img alt="" class="img-circle" src="${syspath}/deng/images/default/user.png" />
                                    	</c:when>
                                    	<c:otherwise>
											<input type="hidden" id="user_img" value="${xtUserinfo.xt_userinfo_image }">
                                    		<img alt="" class="img-circle" id="user_img_pic" style="width: 40px"/>
                                    	</c:otherwise>
                                    </c:choose>
