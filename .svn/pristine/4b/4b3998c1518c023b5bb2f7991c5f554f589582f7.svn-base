...
<body>
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			<button class="btn btn-default" onclick="ZxSignContractUserChoose()">
...
<script type="text/javascript" src="../view/pc/zx-view/zx-sign-contract/zx-sign-contract-user-choose.js"></script> 
</html>
