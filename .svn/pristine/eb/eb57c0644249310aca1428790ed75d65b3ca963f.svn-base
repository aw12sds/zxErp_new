...
<body>
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			<button class="btn btn-default" onclick="ZxRelieveContractUserChoose()">
...
<script type="text/javascript" src="../view/pc/zx-view/zx-relieve-contract/zx-relieve-contract-user-choose.js"></script> 
</html>
