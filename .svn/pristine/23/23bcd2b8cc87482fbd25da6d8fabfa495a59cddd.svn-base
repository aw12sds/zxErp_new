...
<body>
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			<button class="btn btn-default" onclick="ZxStaffRecordUserChoose()">
...
<script type="text/javascript" src="../view/pc/zx-view/zx-staff-record/zx-staff-record-user-choose.js"></script> 
</html>
