								...
								<div class="row">
							        ...
							        <div class="col-md-2">
							        	<div class="form-group">
							        		<input class="form-control" readOnly type="text" maxlength="255" style="width: 150px;" value="${judge_date_start}"  name="judge_date_start">
							        	</div>
							        </div>
							    </div>
							    <div class="row">
							        ...
							        <div class="col-md-2">
							        	<div class="form-group">
							        		<input class="form-control" readOnly type="text" maxlength="255" style="width: 150px;" value="${judge_date_end}"  name="judge_date_end">
							        	</div>
							        </div>
							    </div>
							    <div class="row">
