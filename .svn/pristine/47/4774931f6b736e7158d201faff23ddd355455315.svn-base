	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			<div class="form-group">
				...
				<div class="col-lg-6">
					<div class="input-group" style="width:280px;" >
		        		<input class="form-control" type="hidden"  data-bv-notempty data-bv-notempty-message="请选择商户、卖家" placeholder="请选择商户、卖家" name="b_seller_product_id" id="b_seller_product_id"/> 
						...
						<span class="input-group-btn">
							<button class="btn btn-default" type="button" onclick="initBSellerProductList()">
								请选择
							</button>
						</span>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" style="width:280px;"  maxlength="32" readonly="readonly" id="b_product_name">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;牌</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" style="width:280px;"  maxlength="32" readonly="readonly" id="b_brand_name">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;类</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" style="width:280px;"  maxlength="32" readonly="readonly" id="b_category_name">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">库&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存</label>
				<div class="col-lg-6">
					<input class="form-control" maxlength="10" value="0" style="width:120px;" data-bv-numeric data-bv-numeric-message="库&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存为数字类型"  name="b_stock_countable_sell" placeholder="请输入库&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">可&nbsp;&nbsp;卖&nbsp;数</label>
				<div class="col-lg-6">
					<input class="form-control" maxlength="10" value="0" style="width:120px;" data-bv-numeric data-bv-numeric-message="可&nbsp;&nbsp;卖&nbsp;数为数字类型"  name="b_stock_locks_number" placeholder="请输入可&nbsp;&nbsp;卖&nbsp;数">
				</div>
			</div>
			<div class="form-group">
