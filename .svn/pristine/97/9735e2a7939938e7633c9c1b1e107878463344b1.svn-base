...
<body>  
	...
	<div class="panel-body">
		<div class="btn-group pull-right" style="margin-right: 20px;">
			<button class="btn btn-default" onclick="toZxSixSAdd()">
				<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
			</button>
			<button class="btn btn-default" onclick="toZxSixSUpdate()">
			...
			<button class="btn btn-default" onclick="toZxSixSFabu()">
				<span class="glyphicon glyphicon-flag" aria-hidden="true"></span>发布
			</button>
			<button class="btn btn-default" onclick="delZxSixS()">
