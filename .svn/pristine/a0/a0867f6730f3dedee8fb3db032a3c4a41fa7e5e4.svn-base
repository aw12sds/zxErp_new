	...
	<div class="panel-body">
		...
		<form class="form-horizontal" id="defaultForm" method="post">
			<div class="form-group" style="display:none">
				...
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32" value="${xt_user_id }"  id="xt_user_id" name="xt_user_id" placeholder="请输入用户id">
				</div>
			</div>
			<div class="form-group">   
				<label class="col-lg-3 control-label">姓名</label>   
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="32" onclick="toChooseUser()" value="${user_name }" id="user_name" name="user_name" data-bv-notempty data-bv-notempty-message="请选择员工" placeholder="请选择员工">
				</div>
			</div>
			<div class="form-group">
				<label class="col-lg-3 control-label">合同编号</label>
				<div class="col-lg-6">
					<input class="form-control" type="text" maxlength="10"  name="contract_num" data-bv-notempty data-bv-notempty-message="请输入合同编号" placeholder="请输入合同编号">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<button type="button" class="btn green" onclick="addZxSignContract()">保存</button>
...
<script type="text/javascript" src="../view/pc/zx-view/zx-sign-contract/zx-sign-contract-add.js"></script> 
</html>
