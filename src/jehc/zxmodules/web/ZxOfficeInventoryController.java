...
public class ZxOfficeInventoryController extends BaseAction{
	...
	*/
	...
	public ModelAndView loadZxOfficeInventory(ZxOfficeInventory zxOfficeInventory,HttpServletRequest request){
		return new ModelAndView("pc/zx-view/zx-office-inventory/zx-office-list");
	}
	/**
	* 库存用品右边目录
	* @param zx_office_inventory 
		...
		if(null != id && !"".equals(id) && "0".equals(id)){
			...
			for(int i = 0; i < zxOfficeClassifyList.size(); i++){
				...
				if(i==(zxOfficeClassifyList.size()-1)){
					jsonStr.append("{id:'"+zxOfficeClassify.getClassify_id()+"',text:'"+zxOfficeClassify.getClassify_name()+"',num:'"+"',icon:'../deng/images/icons/depart.png',classify_parentId:'"+zxOfficeClassify.getClassify_parentId()+"',type:'分类'}");  
				}else{
					jsonStr.append("{id:'"+zxOfficeClassify.getClassify_id()+"',text:'"+zxOfficeClassify.getClassify_name()+"',icon:'../deng/images/icons/depart.png',classify_parentId:'"+zxOfficeClassify.getClassify_parentId()+"',type:'分类'},");
				}
			}
			jsonStr.append("]");
		}else{
			...
			for(int i = 0; i < zxOfficeClassifyList.size(); i++){
				...
				if(i==(zxOfficeClassifyList.size()-1)){
					jsonStr.append("{id:'"+zxOfficeClassify.getClassify_id()+"',text:'"+zxOfficeClassify.getClassify_name()+"',leaf:"+leaf+",icon:'../deng/images/icons/depart.png',classify_parentId:'"+zxOfficeClassify.getClassify_parentId()+"',type:'分类'}");  
				}else{
					jsonStr.append("{id:'"+zxOfficeClassify.getClassify_id()+"',text:'"+zxOfficeClassify.getClassify_name()+"',leaf:"+leaf+",icon:'../deng/images/icons/depart.png',classify_parentId:'"+zxOfficeClassify.getClassify_parentId()+"',type:'分类'},");  
				}
			}
