...
public class ZxSupplierController extends BaseAction{
	...
	* @param request 
	*/
	@RequestMapping(value="/toZxSupplierAdd",method={RequestMethod.POST,RequestMethod.GET})
	public ModelAndView toZxSupplierAdd(ZxCar zxCar,HttpServletRequest request){
		return new ModelAndView("pc/zx-view/zx-supplier/zx-supplier-add");
	}
	/**
	* 发送至编辑页面
	* @param request 
	*/
	@RequestMapping(value="/toZxSupplierUpdate",method={RequestMethod.POST,RequestMethod.GET})
	public ModelAndView toZxSupplierUpdate(String id,HttpServletRequest request, Model model){
		ZxSupplier zxSupplier = zxSupplierService.getZxSupplierById(id);
		model.addAttribute("zxSupplier", zxSupplier);
		return new ModelAndView("pc/zx-view/zx-supplier/zx-supplier-update");
	}
	/**
	* 发送至明细页面
	* @param request 
	*/
	@RequestMapping(value="/toZxSupplierDetail",method={RequestMethod.POST,RequestMethod.GET})
	public ModelAndView toZxSupplierDetail(String id,HttpServletRequest request, Model model){
		ZxSupplier zxSupplier = zxSupplierService.getZxSupplierById(id);
		model.addAttribute("zxSupplier", zxSupplier);
		return new ModelAndView("pc/zx-view/zx-supplier/zx-supplier-detail");
	}
}
